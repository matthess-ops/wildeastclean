    ...
    <div class="container">
        ...
        <form action="{{ route('updateBook', ['id' => $book->id]) }} }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" value= {{$book->price}} name="price" id="price" class="form-control" placeholder="" aria-describedby="helpId">
                @error('price')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            {{-- <div class="form-group">
                ...
                <img src="{{ asset('/storage/images/books/'.$book->main_image) }}" name="price" id="price" class="img-fluid" alt="Responsive image">
